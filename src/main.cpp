...
#include <vector>
#include <memory>
#include "GLViewAssignment_FinalProject.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAssignment_FinalProject > glView( Aftr::GLViewAssignment_FinalProject::New( args ) );
