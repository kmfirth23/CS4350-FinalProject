...
void Aftr::AftrImGui_Assignment_FinalProject::draw()
{
   this->draw_orbit_controls();
}

void Aftr::AftrImGui_Assignment_FinalProject::draw_orbit_controls()
{
...
Aftr::Mat4 Aftr::AftrImGui_Assignment_FinalProject::compute_pose( Mat4 const& origin )
{
   if( !this->isPaused )
